...
function gcd (){
    ...
    if(userAnsw === `${exampleGCD(randomNumbers1, randomNumbers2)}`) {logic = 'Correct!'}
    else if(userAnsw !== `${exampleGCD(randomNumbers1, randomNumbers2)}`) {console.log(`'${userAnsw}' is wrong answer ;(. Correct answer was '${exampleGCD(randomNumbers1, randomNumbers2)}'.`)
